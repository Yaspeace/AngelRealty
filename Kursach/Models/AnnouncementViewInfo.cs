...
namespace Kursach.Models
{
    public class AnnouncementViewInfo : AdViewInfo
    {
        ...
        public AnnouncementViewInfo(int id, string name, string imagePath, int roomsNum, int? flour, int totalFlours, double square, decimal price, string address, string realtyType, bool isFavorite, int viewsNum, List<AdImageModel> images)
